...
const routes = [
  ...
  },
  {
    ...
    key: "system-admin-course-preview",
    icon: <Icon fontSize="small">visibility</Icon>,
    route: "/system-admin/courses/:templateId/preview",
  ...
  {
    type: "collapse",
    name: "Template Module Preview",
    key: "system-admin-module-preview",
    icon: <Icon fontSize="small">play_circle</Icon>,
    route: "/system-admin/courses/:templateId/preview/modules/:moduleId/learn",
